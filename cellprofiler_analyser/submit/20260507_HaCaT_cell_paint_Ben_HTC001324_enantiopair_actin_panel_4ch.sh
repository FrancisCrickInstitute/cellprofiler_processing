#!/bin/bash
#SBATCH --job-name=HTC_enantiopair_actin_panel_4ch
#SBATCH --mem=100G
...
CONFIG_FILE="./cellprofiler_analyser/config/config_20260507_HaCaT_cell_paint_Ben_HTC001324_enantiopair_actin_panel_4ch.yml"
