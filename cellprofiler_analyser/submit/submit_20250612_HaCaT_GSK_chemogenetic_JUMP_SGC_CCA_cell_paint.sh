...
METADATA_FILE="/nemo/project/proj-prosperity/hts/raw/projects/20250612_HaCaT_GSK_chemogenetic_JUMP_SGC_CCA_cell_paint/data/meta_data/GSK_chemogenetic_JUMP_SGC_CCA.csv"
CONFIG_FILE="./cellprofiler_analyser/config/config_20250612_HaCaT_GSK_chemogenetic_JUMP_SGC_CCA_cell_paint.yml"
